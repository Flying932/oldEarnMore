...
# -----------------------------------------------------------------------------
# Parallel training profile for Mask-SAC on DJ30.
...
LOCAL_DEFAULTS = {
    ...
    "days": 10,
    "batch_size": 128,
    # Keep effective replay capacity close to single-env 100000.
    # With num_envs=8, use 12500 to avoid oversized storage.
    "buffer_size": 12500,
    "horizon_len": 128,
    "embed_dim": 64,
    "depth": 1,
    ...
    # runtime (parallel profile)
    "seed": 42,
    "num_envs": 8,
    "vector_env_type": "async",  # "sync" | "async"
    # Replay buffer on GPU is too large with vectorized transitions.
