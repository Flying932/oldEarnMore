root = None
workdir = 'workdir'
tag = 'mask_sac_nepx2000_daysx10_bsx128_bufsx10000_hlx128_edx128_depx1_dedx128_dedepx1_rtx128_lrx1e-05_sdx42_nvx10_actlrx1e-05_crilrx1e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_dj30_dgx0'
num_stocks = 28
num_envs = 10
num_features = 102
temporal_dim = 3
...
transition_shape = dict(
    state=dict(shape=(10, 28, 10, 102), type='float32'),
    action=dict(shape=(10, 29), type='float32'),
    mask=dict(shape=(10, 28), type='int32'),
    ids_restore=dict(shape=(10, 28), type='int64'),
    reward=dict(shape=(10, ), type='float32'),
    done=dict(shape=(10, ), type='float32'),
    next_state=dict(shape=(10, 28, 10, 102), type='float32'))
dataset = dict(
...
rep_net = dict(
    ...
    mask_ratio_mu=0.7,
    mask_ratio_std=0.1)
act_net = dict(type='ActorMaskSAC', embed_dim=128, depth=1, cls_embed=True)
cri_net = dict(type='CriticMaskSAC', embed_dim=128, depth=1, cls_embed=True)
