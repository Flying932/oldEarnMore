...
agent = dict(
    ...
    transition_shape=dict(
        ...
        done=dict(shape=(15, ), type='float32'),
        ...
        reward=dict(shape=(15, ), type='float32'),
        state=dict(shape=(
            15,
            28,
            10,
...
seed = 42
stocks_path = 'datasets/dj30/stocks.txt'
tag = 'mask_sac_nepx2000_daysx10_bsx128_bufsx7000_hlx128_edx64_depx1_dedx64_dedepx1_rtx128_lrx1e-05_sdx42_nvx15_actlrx1e-05_crilrx1e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxsoftmax_Tx0.1_dj30_dgx0'
temporal_dim = 3
