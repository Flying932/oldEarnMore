root = None
workdir = 'workdir'
tag = 'mask_sac_nepx2000_daysx10_bsx64_bufsx10000_hlx64_edx64_depx1_dedx64_dedepx1_rtx32_lrx1e-05_sdx42_nvx5_vecxasync_bufdevxcpu_actlrx1e-05_crilrx1e-05_replrx1e-05_betlrx1e-05_repwx1.0_betwx0.01_awmxreweight_Tx0.1_dj30_dgx0'
num_stocks = 28
num_envs = 5
num_features = 102
temporal_dim = 3
...
transition_shape = dict(
    state=dict(shape=(5, 28, 10, 102), type='float32'),
    action=dict(shape=(5, 29), type='float32'),
    mask=dict(shape=(5, 28), type='int32'),
    ids_restore=dict(shape=(5, 28), type='int64'),
    reward=dict(shape=(5, ), type='float32'),
    done=dict(shape=(5, ), type='float32'),
    next_state=dict(shape=(5, 28, 10, 102), type='float32'))
dataset = dict(
